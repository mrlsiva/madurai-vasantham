...
<body>
<nav class="chitfund-nav navbar navbar-expand-lg navbar-dark">
  <div class="container-fluid">
   
    <a class="navbar-brand" href="{{ route('chitfundIndex') }}"><span class="logo-container">
				<img src="{{asset('/resources/assets_chitfund/images/logo-icon.png')}}" class="mx-auto" style="width: 60px;"  alt="">
			<span class="logo-txt">Vasantham Siru Semippu Thittam</span></span></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="{{ route('chitfundIndex') }}"> Plans</a>
        </li>
			...
			<li class="nav-item dropdown">
				...
				<i class="fa fa-user"></i> Admin{{ Auth::user() }}
				</a>
				<ul class="dropdown-menu logout-menu" aria-labelledby="navbarScrollingDropdown">
					<li>
