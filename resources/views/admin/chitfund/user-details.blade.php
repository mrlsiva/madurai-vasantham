													...
													<td>
														...
														@php 
															...
															if( $u->due_status == 1 ){		
																...
																$whatsapp_message = urlencode("Dear *$u->user_name*, Token Number *$u->token_id* you have paid Rs:$u->plan_amount for the date $date of vasantham chit fund $u->plan_name. \n \n Thank you. \n Vasantham Group Of Companies");
